...
-   [DT](https://rstudio.github.io/DT/) provides an R interface to the JavaScript library Data tables that create interactive table on html page.
...
[ggiraph](https://davidgohel.github.io/ggiraph/) is an htmlwidget and a ggplot2 extension. It allow ggplot graphics to be interactive.

Interactive is made with [ggplot geometrics](https://davidgohel.github.io/ggiraph/reference/index.html#section-interactive-geometries) that can understand three arguments. · **Tooltip**：a column of data-sets that contain tooltips to be displayed when the mouse is over elements. · **Onclick**: a column of data-sets that contains a JavaScript functions to be executed when elements are clicked. · **Data_id**: a column of data-sets that contain an id to be associated with elements.

If it used within a shiny application, elements associated with an id(data_id) can be selected and manipulated on client and server sides. For more details Please refere to this [article](https://www.ardata.fr/ggiraph-book/selections.html).

### 3.4.1 **Tooltip effect with *tooltip* aesthetic**

Below shows a typical code chunk to plot an interactive statistical graph by using **ggiraph** package. Notice that the code chunk consists of two parts. First, an ggplot object will be created. Next, [girage()](https://davidgohel.github.io/ggiraph/reference/girafe.html) of **ggiraph** will be used to create an interactive svg object.
...
## 3.5.1 **Displaying multple information on tooltip**
...
Code Chunk below use [opts_tooltip()](https://davidgohel.github.io/ggiraph/reference/opts_tooltip.html) of **ggiraph** to customize tooltip rendering by add css declarations.
...
### 3.6.2 **Displaying Statistic On Tooltip**
...
2.  patchwork function of [patchwork](https://patchwork.data-imaginist.com/) pakcage will be used inside girafe function to create the interactive coordinated multiple views.
...
![](img/Ex3Etc1.jpg) There are two ways to create interactive graph by using plotly, they are:
...
-   [hightlight_ley()](https://www.rdocumentation.org/packages/plotly/versions/4.9.2/topics/highlight_key) of plotly package is used as shared data.

-   Two scatterplots ill be created by using ggplot2 functions.
...
-   [How to Plot With Ggiraph](https://www.r-bloggers.com/2018/04/how-to-plot-with-ggiraph/) [Interactive map of France with ggiraph](http://rstudio-pubs-static.s3.amazonaws.com/152833_56a4917734204de7b37881d164cf8051.html)
