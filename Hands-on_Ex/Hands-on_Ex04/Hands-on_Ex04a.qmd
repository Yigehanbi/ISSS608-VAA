---
title: "Hands-on_Ex04 - Visualising Distribution"
author: "Xi Zixun"
---
...
## 9.3 Visualing Distribution with Ridgeline Plot
...
![](img/93img.png) \### 9.3.1 Plotting Ridgeline Graph: ggridges method
...
### 9.3.4 Ridgeline Plot With Quartile Lines
...
### 9.4.2 Adding The Box Plot With `geom_boxplot()`
...
### 9.4.3 Adding The Dots Plots with `stat_dots()`
